...
Technically, there is an easier approach with this since we do not require a lot of dependencies since we are using very simple python scripts but as a newbie that I am with Python, I'll stick using `venv` as I am taking a page out of Steven Wenzel's APM Kubernetes sandbox :P
